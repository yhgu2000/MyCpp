...
#
# override_glob(<variable> <origin> <override>
#               <EXPRESSIONS <exprs>...>
#               [RECURSE]
#               [ARGUMENTS <args>...])
#
...
function(override_glob variable origin override)
  ...
  file(${glob_command} origin_globs
    RELATIVE ${origin}
    ${_ARGUMENTS} ${origin_exprs}
  )
  ...
  file(${glob_command} override_globs
    RELATIVE ${override}
    ${_ARGUMENTS} ${override_exprs}
  )
  ...
  endforeach()
  set(${variable} ${globs} PARENT_SCOPE)
endfunction()
